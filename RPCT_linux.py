...
# ROC cruve
def parse_roc(args):
    RocMP.roc_graph(args.file[0], args.output[0], args.number[0], args.c_number[0], args.gamma[0], now_path)


# filter features
def parse_filter(args):
    TrainFP.filter_pro(args.file[0], args.output[0], args.c_number[0], args.gamma[0], args.cross_validation[0],
                       args.number[0], args.round[0], now_path)
...
def parse_fffs(args):
    ReadBE.read_filter(args.file[0], args.filter_index[0], args.output[0], args.end_feature[0], args.lenth_features[0],
                       now_path)
...
def rpct_main():
    ...
    parser_ro.add_argument('-n', '--number', nargs=1, help='features number')
    ...
    parser_fi.add_argument('-n', '--number', nargs=1, help='features number')
    ...
    parser_ff.add_argument('-l', '--lenth_features', nargs=1, help='lenth of features')
